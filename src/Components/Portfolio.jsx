 ...
 */
import image from "../images/backend3.jpg";

const imageAltText = "laptop on a desk";
...
const projectList = [
  ...
  },
  {
    ...
    url: "https://favourite101.github.io/My-Portfolio-Website",
  },
  {
    title: "ToDO List API",
    description:
      "Created a RESTful API for a ToDO list application. Worked on the backend of the application.",
